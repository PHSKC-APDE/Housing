...
# Bring in function
devtools::source_url("https://raw.githubusercontent.com/PHSKC-APDE/Housing/azure2019/etl/raw/load_raw.sha_2004_2015.R")
...
# Bring in function
devtools::source_url("https://raw.githubusercontent.com/hcvSKC-APDE/Housing/azure2019/etl/raw/load_raw.sha_2004_2015.R")
...
# LOAD 2016 DATA ----
# Bring in function
devtools::source_url("https://raw.githubusercontent.com/PHSKC-APDE/Housing/azure2019/etl/raw/load_raw.sha_2016.R")
...
# Run function
load_raw.sha_2016(conn = db_hhsaw,
                   to_schema = "pha",
                   to_table = "raw_sha_2016",
                   qa_schema = qa_schema,
                   qa_table = qa_table,
                   file_path_sha = file_path_sha,
                   date_min = "2016-01-01",
                   date_max = "2016-12-31",
...
# Clean up
rm(load_raw.sha_2016, etl_batch_id_2016)


# LOAD 2017 DATA ----
# Bring in function
devtools::source_url("https://raw.githubusercontent.com/PHSKC-APDE/Housing/azure2019/etl/raw/load_raw.sha_2017.R")
...
# Run function
load_raw.sha_2017(conn = db_hhsaw,
                   to_schema = "pha",
                   to_table = "raw_sha_2017",
                   qa_schema = qa_schema,
                   qa_table = qa_table,
                   file_path_sha = file_path_sha,
                   date_min = "2017-01-01",
...
# Clean up
rm(load_raw.sha_2017, etl_batch_id_2017)


# LOAD 2018 DATA ----
# Bring in function
devtools::source_url("https://raw.githubusercontent.com/PHSKC-APDE/Housing/azure2019/etl/raw/load_raw.sha_2018.R")
...
# Run function
load_raw.sha_2018(conn = db_hhsaw,
                   to_schema = "pha",
                   to_table = "raw_sha_2018",
                   qa_schema = qa_schema,
                   qa_table = qa_table,
                   file_path_sha = file_path_sha,
                   date_min = "2018-01-01",
...
# Clean up
rm(load_raw.sha_2018, etl_batch_id_2018)
...
# LOAD 2020 DATA ----
# Bring in function
devtools::source_url("https://raw.githubusercontent.com/PHSKC-APDE/Housing/azure2020/etl/raw/load_raw.sha_2020.R")
...
# Run function
load_raw.sha_2020(conn = db_hhsaw,
                   to_schema = "pha",
...
# Clean up
rm(load_raw.sha_2020, etl_batch_id_2020)
