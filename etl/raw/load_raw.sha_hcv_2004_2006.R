...
load_raw.sha_hcv_2004_2006 <- function(conn = NULL,
                                    to_schema = NULL,
                                    to_table = NULL,
                                    qa_schema = NULL,
                                    qa_table = NULL,
  ...
  sha_hcv_p1_2004_2006 <- fread(file = file.path(file_path, "sha_hcv_2004-2006_suffix_corrected.csv"), 
                             na.strings = c("NA", "", "NULL", "N/A", "."), 
                             stringsAsFactors = F)
  sha_hcv_p2_2004_2006 <- fread(file = file.path(file_path, "sha_ph_2004-2006_panel_02_income_suffix_corrected.csv"), 
                               na.strings = c("NA", "", "NULL", "N/A", "."), 
                               stringsAsFactors = F)
  sha_hcv_p3_2004_2006 <- fread(file = file.path(file_path, "sha_ph_2004-2006_panel_03_assets_suffix_corrected.csv"), 
                               na.strings = c("NA", "", "NULL", "N/A", "."), 
                               stringsAsFactors = F)
