...
# BRING IN DATA ----
# KCHA
kcha <- dbGetQuery(db_hhsaw, "SELECT * FROM pha.raw_kcha_waitlist_2017")

# SHA
sha <- dbGetQuery(db_hhsaw, "SELECT * FROM pha.raw_sha_waitlist_2017")
...
lapply(seq(start, cycles), function(i) {
  ...
  if (i == 1) {
    dbWriteTable(db_hhsaw,
                 name = DBI::Id(schema = "pha",  table = "stage_pha_waitlist"),
