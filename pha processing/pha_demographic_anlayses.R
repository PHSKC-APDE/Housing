...
#### Bring in data ####
pha_elig_final <- readRDS(file = paste0(path, "/OrganizedData/pha_elig_final.Rda"))
...
pha_elig_demogs <- left_join(pha_elig_demogs, pt_temp_h, by = c("pid", "startdate_c", "enddate_c"))
rm(pt_temp_h)

# Person-time in Medicaid, needs to be done separately to avoid errors
pt_temp_m <- pha_elig_demogs %>%
...
pha_elig_demogs <- left_join(pha_elig_demogs, pt_temp_m, by = c("pid", "startdate_c", "enddate_c"))
rm(pt_temp_m)

# Person-time in both, needs to be done separately to avoid errors
pt_temp_o <- pha_elig_demogs %>%
...
pha_elig_demogs <- left_join(pha_elig_demogs, pt_temp_o, by = c("pid", "startdate_c", "enddate_c"))
rm(pt_temp_o)
...
### KCHA
# Monthly
agency_count_hh_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "major_prog", "enroll_type"), period = "month", agency = "kcha", unit = hhold_id_new)
program_count_hh_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "prog_final", "spec_purp_type", "enroll_type"), period = "month", agency = "kcha", unit = hhold_id_new)
portfolio_count_hh_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "portfolio_final", "enroll_type"), period = "month", agency = "kcha", unit = hhold_id_new)
race_count_hh_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "race2", "enroll_type"), period = "month", agency = "kcha", unit = hhold_id_new)
agegrp_count_hh_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "agegrp", "enroll_type"), period = "month", agency = "kcha", unit = hhold_id_new)
disability_count_hh_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "disability2", "enroll_type"), period = "month", agency = "kcha", unit = hhold_id_new)
gender_count_hh_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "gender2", "enroll_type"), period = "month", agency = "kcha", unit = hhold_id_new)
zip_count_hh_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "unit_zip_new", "kc_area", "enroll_type"), period = "month", agency = "kcha", unit = hhold_id_new)

agency_count_ind_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "major_prog", "enroll_type"), period = "month", agency = "kcha", unit = pid2)
program_count_ind_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "prog_final", "spec_purp_type", "enroll_type"), period = "month", agency = "kcha", unit = pid2)
portfolio_count_ind_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "portfolio_final", "enroll_type"), period = "month", agency = "kcha", unit = pid2)
race_count_ind_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "race2", "enroll_type"), period = "month", agency = "kcha", unit = pid2)
agegrp_count_ind_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "agegrp", "enroll_type"), period = "month", agency = "kcha", unit = pid2)
disability_count_ind_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "disability2", "enroll_type"), period = "month", agency = "kcha", unit = pid2)
gender_count_ind_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "gender2", "enroll_type"), period = "month", agency = "kcha", unit = pid2)
zip_count_ind_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "unit_zip_new", "kc_area", "enroll_type"), period = "month", agency = "kcha", unit = pid2)

# Yearly
agency_count_yr_hh_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "major_prog", "enroll_type"), period = "year", agency = "kcha", unit = hhold_id_new)
program_count_yr_hh_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "prog_final", "spec_purp_type", "enroll_type"), period = "year", agency = "kcha", unit = hhold_id_new)
portfolio_count_yr_hh_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "portfolio_final", "enroll_type"), period = "year", agency = "kcha", unit = hhold_id_new)
race_count_yr_hh_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "race2", "enroll_type"), period = "year", agency = "kcha", unit = hhold_id_new)
agegrp_count_yr_hh_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "agegrp", "enroll_type"), period = "year", agency = "kcha", unit = hhold_id_new)
disability_count_yr_hh_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "disability2", "enroll_type"), period = "year", agency = "kcha", unit = hhold_id_new)
gender_count_yr_hh_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "gender2", "enroll_type"), period = "year", agency = "kcha", unit = hhold_id_new)
zip_count_yr_hh_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "unit_zip_new", "kc_area", "enroll_type"), period = "year", agency = "kcha", unit = hhold_id_new)

agency_count_yr_ind_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "major_prog", "enroll_type"), period = "year", agency = "kcha", unit = pid2)
program_count_yr_ind_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "prog_final", "spec_purp_type", "enroll_type"), period = "year", agency = "kcha", unit = pid2)
portfolio_count_yr_ind_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "portfolio_final", "enroll_type"), period = "year", agency = "kcha", unit = pid2)
race_count_yr_ind_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "race2", "enroll_type"), period = "year", agency = "kcha", unit = pid2)
agegrp_count_yr_ind_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "agegrp", "enroll_type"), period = "year", agency = "kcha", unit = pid2)
disability_count_yr_ind_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "disability2", "enroll_type"), period = "year", agency = "kcha", unit = pid2)
gender_count_yr_ind_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "gender2", "enroll_type"), period = "year", agency = "kcha", unit = pid2)
zip_count_yr_ind_kcha <- counts(pha_elig_demogs, group_var = c("agency_new", "unit_zip_new", "kc_area", "enroll_type"), period = "year", agency = "kcha", unit = pid2)

### SHA
agency_count_hh_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "major_prog", "enroll_type"), period = "month", agency = "sha", unit = hhold_id_new)
program_count_hh_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "prog_final", "spec_purp_type", "enroll_type"), period = "month", agency = "sha", unit = hhold_id_new)
portfolio_count_hh_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "portfolio_final", "enroll_type"), period = "month", agency = "sha", unit = hhold_id_new)
race_count_hh_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "race2", "enroll_type"), period = "month", agency = "sha", unit = hhold_id_new)
agegrp_count_hh_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "agegrp", "enroll_type"), period = "month", agency = "sha", unit = hhold_id_new)
disability_count_hh_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "disability2", "enroll_type"), period = "month", agency = "sha", unit = hhold_id_new)
gender_count_hh_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "gender2", "enroll_type"), period = "month", agency = "sha", unit = hhold_id_new)
zip_count_hh_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "unit_zip_new", "kc_area", "enroll_type"), period = "month", agency = "sha", unit = hhold_id_new)

agency_count_ind_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "major_prog", "enroll_type"), period = "month", agency = "sha", unit = pid2)
program_count_ind_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "prog_final", "spec_purp_type", "enroll_type"), period = "month", agency = "sha", unit = pid2)
portfolio_count_ind_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "portfolio_final", "enroll_type"), period = "month", agency = "sha", unit = pid2)
race_count_ind_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "race2", "enroll_type"), period = "month", agency = "sha", unit = pid2)
agegrp_count_ind_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "agegrp", "enroll_type"), period = "month", agency = "sha", unit = pid2)
disability_count_ind_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "disability2", "enroll_type"), period = "month", agency = "sha", unit = pid2)
gender_count_ind_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "gender2", "enroll_type"), period = "month", agency = "sha", unit = pid2)
zip_count_ind_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "unit_zip_new", "kc_area", "enroll_type"), period = "month", agency = "sha", unit = pid2)

# Yearly
agency_count_yr_hh_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "major_prog", "enroll_type"), period = "year", agency = "sha", unit = hhold_id_new)
program_count_yr_hh_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "prog_final", "spec_purp_type", "enroll_type"), period = "year", agency = "sha", unit = hhold_id_new)
portfolio_count_yr_hh_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "portfolio_final", "enroll_type"), period = "year", agency = "sha", unit = hhold_id_new)
race_count_yr_hh_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "race2", "enroll_type"), period = "year", agency = "sha", unit = hhold_id_new)
agegrp_count_yr_hh_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "agegrp", "enroll_type"), period = "year", agency = "sha", unit = hhold_id_new)
disability_count_yr_hh_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "disability2", "enroll_type"), period = "year", agency = "sha", unit = hhold_id_new)
gender_count_yr_hh_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "gender2", "enroll_type"), period = "year", agency = "sha", unit = hhold_id_new)
zip_count_yr_hh_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "unit_zip_new", "kc_area", "enroll_type"), period = "year", agency = "sha", unit = hhold_id_new)

agency_count_yr_ind_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "major_prog", "enroll_type"), period = "year", agency = "sha", unit = pid2)
program_count_yr_ind_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "prog_final", "spec_purp_type", "enroll_type"), period = "year", agency = "sha", unit = pid2)
portfolio_count_yr_ind_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "portfolio_final", "enroll_type"), period = "year", agency = "sha", unit = pid2)
race_count_yr_ind_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "race2", "enroll_type"), period = "year", agency = "sha", unit = pid2)
agegrp_count_yr_ind_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "agegrp", "enroll_type"), period = "year", agency = "sha", unit = pid2)
disability_count_yr_ind_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "disability2", "enroll_type"), period = "year", agency = "sha", unit = pid2)
gender_count_yr_ind_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "gender2", "enroll_type"), period = "year", agency = "sha", unit = pid2)
zip_count_yr_ind_sha <- counts(pha_elig_demogs, group_var = c("agency_new", "unit_zip_new", "kc_area", "enroll_type"), period = "year", agency = "sha", unit = pid2)
...
gender_count <- bind_rows(gender_count_hh_kcha, gender_count_ind_kcha, gender_count_yr_hh_kcha, gender_count_yr_ind_kcha,
  ...
  mutate(category = "Gender", group = gender2)
...
pha_count <- bind_rows(agency_count, program_count, portfolio_count, race_count, agegrp_count, disability_count, gender_count, zip_count) %>%
...
pha_count <- bind_rows(agency_count) %>%
  mutate(unit = car::recode(unit, "'hhold_id_new' = 'Households'; 'pid2' = 'Individuals'"),
         date_yr = ifelse(period == "year", year(date), NA))
...
temp12 <- pha_elig_demogs %>% filter(dec12_h == 1 & dec12_m == 0) %>% distinct(pid, .keep_all = TRUE) %>% 
...
temp13 <- pha_elig_demogs %>% filter(dec13_h == 1 & dec13_m == 0) %>% distinct(pid, .keep_all = TRUE) %>% 
  group_by(agency_new, major_prog, prog_type_new, spec_purp_type, portfolio_new, property_name_new, gender_new_m6, adult, senior, disability, race2) %>% 
  summarise(count = n()) %>% mutate(year = 2013)
temp14 <- pha_elig_demogs %>% filter(dec14_h == 1 & dec14_m == 0) %>% distinct(pid, .keep_all = TRUE) %>% 
  group_by(agency_new, major_prog, prog_type_new, spec_purp_type, portfolio_new, property_name_new, gender_new_m6, adult, senior, disability, race2) %>% 
  summarise(count = n()) %>% mutate(year = 2014)
temp15 <- pha_elig_demogs %>% filter(dec15_h == 1 & dec15_m == 0) %>% distinct(pid, .keep_all = TRUE) %>% 
  group_by(agency_new, major_prog, prog_type_new, spec_purp_type, portfolio_new, property_name_new, gender_new_m6, adult, senior, disability, race2) %>% 
  summarise(count = n()) %>% mutate(year = 2015)
temp16 <- pha_elig_demogs %>% filter(dec16_h == 1 & dec16_m == 0) %>% distinct(pid, .keep_all = TRUE) %>% 
  group_by(agency_new, major_prog, prog_type_new, spec_purp_type, portfolio_new, property_name_new, gender_new_m6, adult, senior, disability, race2) %>% 
...
temp12 <- pha_elig_demogs %>% filter(dec12_h == 1 & dec12_m == 1) %>% distinct(pid, .keep_all = TRUE) %>% 
  group_by(agency_new, major_prog, prog_type_new, spec_purp_type, portfolio_new, property_name_new, gender_new_m6, adult, senior, disability, race2) %>% 
  summarise(count = n()) %>% mutate(year = 2012)
temp13 <- pha_elig_demogs %>% filter(dec13_h == 1 & dec13_m == 1) %>% distinct(pid, .keep_all = TRUE) %>% 
  group_by(agency_new, major_prog, prog_type_new, spec_purp_type, portfolio_new, property_name_new, gender_new_m6, adult, senior, disability, race2) %>% 
  summarise(count = n()) %>% mutate(year = 2013)
temp14 <- pha_elig_demogs %>% filter(dec14_h == 1 & dec14_m == 1) %>% distinct(pid, .keep_all = TRUE) %>% 
  group_by(agency_new, major_prog, prog_type_new, spec_purp_type, portfolio_new, property_name_new, gender_new_m6, adult, senior, disability, race2) %>% 
  summarise(count = n()) %>% mutate(year = 2014)
temp15 <- pha_elig_demogs %>% filter(dec15_h == 1 & dec15_m == 1) %>% distinct(pid, .keep_all = TRUE) %>% 
  group_by(agency_new, major_prog, prog_type_new, spec_purp_type, portfolio_new, property_name_new, gender_new_m6, adult, senior, disability, race2) %>% 
  summarise(count = n()) %>% mutate(year = 2015)
temp16 <- pha_elig_demogs %>% filter(dec16_h == 1 & dec16_m == 1) %>% distinct(pid, .keep_all = TRUE) %>% 
  group_by(agency_new, major_prog, prog_type_new, spec_purp_type, portfolio_new, property_name_new, gender_new_m6, adult, senior, disability, race2) %>% 
  summarise(count = n()) %>% mutate(year = 2016)
...
temp12 <- pha_elig_demogs %>% filter(dec12_h == 0 & dec12_m == 1) %>% distinct(pid) %>% summarise(count = n()) %>% mutate(year = 2012)
temp13 <- pha_elig_demogs %>% filter(dec13_h == 0 & dec13_m == 1) %>% distinct(pid) %>% summarise(count = n()) %>% mutate(year = 2013)
temp14 <- pha_elig_demogs %>% filter(dec14_h == 0 & dec14_m == 1) %>% distinct(pid) %>% summarise(count = n()) %>% mutate(year = 2014)
temp15 <- pha_elig_demogs %>% filter(dec15_h == 0 & dec15_m == 1) %>% distinct(pid) %>% summarise(count = n()) %>% mutate(year = 2015)
temp16 <- pha_elig_demogs %>% filter(dec16_h == 0 & dec16_m == 1) %>% distinct(pid) %>% summarise(count = n()) %>% mutate(year = 2016)
