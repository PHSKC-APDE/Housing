...
# write.xlsx(adds, file = paste0("//phdata01/DROF_DATA/DOH DATA/Housing/Geocoding/PHA addresses for geocoding_", Sys.Date(), ".xlsx"))
...
adds_unmatched <- read.xlsx("data/Housing/OrganizedData/PHA_addresses_unmatched.xlsx")
...
# Save combined file
write.csv(adds_unmatched_bing, "data/Housing/OrganizedData/PHA_addresses_unmatched_bing.csv", row.names = FALSE)
...
tempfilename <- ("data/Housing/OrganizedData/PHA_addresses_matched_google.rds")
...
geocoded <- readRDS("data/Housing/OrganizedData/PHA_addresses_matched_google.rds")
